...
admin.site.register([ProductCategory, ProductGallery, Location, ProductComponent, Cart, PayOuts, Commission, CaseSubCategory, CaseType, CaseMinorCategory, Documentation, SupportTicket, Video, PaymentBalance])